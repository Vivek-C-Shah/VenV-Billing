...
const NavBar = () => {
  ...
  const url = process.env.REACT_APP_VENV;

  useEffect(() => {
    setUser(JSON.parse(localStorage.getItem("profile")));
  }, [location]);

  let loc = process.env.REACT_APP_VENV;
    ...
    <div>
      <nav className="navbar">
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            {/* add portfolio/webite link here venv */}
            <a href="https://github.com/Venv-developers" className="nav-link">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fad"
