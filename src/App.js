...
import GetClientInvoicesSummary from "./components/Invoice/GetClientInvoicesSummary";
import PostBankTransferForm from "./components/Clients/postBankTransfer";
      ...
      <BrowserRouter>
        <SnackbarProvider>
          ...
          <Switch>
            ...
            <Route
              path="/clients/:id/invoices/summary"
              exact
              component={GetClientInvoicesSummary}
            />
            <Route
              path="/bank-transfer"
              exact
              component={PostBankTransferForm}
            />
